...
export default function AcademicHeader() {
  const headingText = "Where My Journey Began";
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center max-w-3xl mx-auto px-6 pt-32 pb-16 z-20 relative">
      ...
      >
        Every classroom, every lesson, and every challenge shaped the foundation that eventually became my career in software engineering and AI.
      </motion.p>
    </div>
  );
}
