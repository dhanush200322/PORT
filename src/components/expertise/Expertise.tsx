...
export default function Expertise() {
  return (
    <section id="expertise" className="relative w-full min-h-screen bg-background py-24 md:py-32 overflow-hidden">
      ...
      */}
      <motion.div 
        ...
        style={{
          ...
          backgroundImage: "radial-gradient(ellipse at center, rgba(79,140,255,0.04) 0%, transparent 60%)"
        }}
      />
