...
export default function HeroVideo() {
  ...
  return (
    ...
    >
      ...
      {/* Sound Toggle Button */}
      <div className="absolute bottom-10 right-10 z-50 pointer-events-auto flex flex-col items-end">
        ...
        <motion.div
          ...
          className="relative mb-3 bg-primary text-white text-xs font-medium px-4 py-2 rounded-full shadow-lg whitespace-nowrap pointer-events-none"
        >
        ...
        <button
          ...
          className="flex items-center gap-3 px-5 py-3 rounded-full bg-black/40 hover:bg-black/60 backdrop-blur-md border border-white/10 text-white/80 transition-all hover:text-white"
          aria-label={isMuted ? "Unmute video" : "Mute video"}
        >
          {isMuted ? (
            <>
              <VolumeX className="w-5 h-5 opacity-70" />
              <span className="text-sm font-medium opacity-70">Sound Off</span>
            </>
          ) : (
            <>
